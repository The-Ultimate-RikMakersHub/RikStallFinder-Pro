...
const vendorRegistry = {
    "sizzle_cafe": {
        ...
        menu: [
            ...
            { category: 'burgers', name: 'Cheese Veg Burger', price: '₹80', desc: 'Classic grilled vegetable patty topped with melted cheese and signature house sauces.', tag: '' },
            { category: 'burgers', name: 'Veg Tandoori Burger', price: '₹100', desc: 'Crispy veg patty layered with rich, smoky tandoori spread and fresh onion slices.', tag: 'Spicy' },
            { category: 'burgers', name: 'Paneer Cheese Burger', price: '₹100', desc: 'Soft spiced paneer slice with a thick cheese layer and crisp garden lettuce.', tag: 'Bestseller' },
            { category: 'burgers', name: 'Cheese Chicken Burger', price: '₹100', desc: 'Griddle-pressed juicy chicken patty topped with creamy melted cheese slice.', tag: '🔥 Fire Pick' },
            { category: 'burgers', name: 'Chicken Ginger Burger', price: '₹120', desc: 'Crispy chicken patty infused with zesty ginger hints and fresh herb aioli.', tag: '' },
            { category: 'burgers', name: 'Chicken Tandoori Burger', price: '₹120', desc: 'Flame-grilled chicken patty slammed with smoky, rich tandoori spices and crunch.', tag: '🔥 Bestseller' },
            { category: 'burgers', name: 'Hot & Spicy Chicken Whopper', price: '₹150', desc: 'Massive double-layered chicken burger packed with fiery hot chiles and spiced dressing.', tag: 'Signature' },
            ...
            { category: 'momos', name: 'Chicken Popcorn (15 Pcs)', price: '₹120', desc: 'Bite-sized premium crunchy chicken nuggets popped to golden perfection.', tag: 'Must Try' },
            { category: 'momos', name: 'Crispy Chicken Wings (4 Pcs)', price: '₹100', desc: 'Four glazed, flame-cooked chicken wings tossed in a crisp spicy rub.', tag: '🔥 Fire Pick' },
            ...
            { category: 'momos', name: 'Chicken Steam Momo', price: '₹80', desc: 'Soft, juicy steamed dumplings stuffed with premium seasoned minced chicken.', tag: 'Bestseller' },
            ...
            { category: 'sizzlers', name: 'Crispy Chilli Potato', price: '₹100', desc: 'Golden fried potato fingers tossed in a sweet, spicy, and tangy Schezwan reduction.', tag: '' },
            { category: 'sizzlers', name: 'Honey Chilli Potato', price: '₹110', desc: 'Crispy potato fingers glazed with raw sweet honey, tossed with sesame seeds.', tag: 'Bestseller' },
            { category: 'sizzlers', name: 'Crispy Chilli Babycorn', price: '₹120', desc: 'Tender baby corn chunks golden-fried and wok-tossed with fresh capsicum.', tag: '' },
            { category: 'sizzlers', name: 'Honey Chilli Babycorn', price: '₹130', desc: 'Crispy golden baby corn pieces coated in a sweet honey and fiery red chili glaze.', tag: '' },
            { category: 'sizzlers', name: 'Chilli Paneer Dry', price: '₹140', desc: 'Fresh paneer cubes stir-fried with onions, bell peppers, soy sauce, and green chilies.', tag: 'Classic' },
            { category: 'sizzlers', name: 'Chilli Paneer Gravy', price: '₹150', desc: 'Soft paneer cubes simmered in a rich, velvety dark soy and chili garlic gravy solution.', tag: '' },
            { category: 'sizzlers', name: 'White Chilli Paneer', price: '₹160', desc: 'A premium, unique white-sauce infused chili paneer with sharp aromatic white peppers.', tag: 'Must Try' },
            { category: 'sizzlers', name: 'Crispy Honey Paneer', price: '₹160', desc: 'Battered paneer cubes fried to a clean crunch and tossed in a sweet honey glaze.', tag: '' },
            { category: 'sizzlers', name: 'Veg Manchurian (8 Pcs)', price: '₹130', desc: 'Eight crispy deep-fried vegetable balls tossed in a rich, tangy Manchurian glaze.', tag: '' },
            { category: 'sizzlers', name: 'Chicken Manchurian (8 Pcs)', price: '₹160', desc: 'Eight minced seasoned chicken rounds fried and glazed in a savory garlic soy sauce.', tag: '' },
            { category: 'sizzlers', name: 'Chicken Lolipop Dry (5 Pcs)', price: '₹150', desc: 'Five classic drummettes frenched, battered, deep-fried, and served with dry spice.', tag: '🔥 Fire Pick' },
            { category: 'sizzlers', name: 'Chicken Lolipop Gravy (5 Pcs)', price: '₹160', desc: 'Five fried chicken drummettes drenched in a rich, slow-simmered hot ginger-soy gravy.', tag: '' },
            { category: 'sizzlers', name: 'Chicken 65 (8 Pcs)', price: '₹180', desc: 'Eight spicy deep-fried chicken cubes tempered with yogurt and curry leaves.', tag: '🔥 Bestseller' },
            { category: 'sizzlers', name: 'Chilli Chicken Dry', price: '₹150', desc: 'Wok-seared crispy chicken chunks tossed with an abundance of fresh green chilies.', tag: 'Classic' },
            { category: 'sizzlers', name: 'Chilli Chicken Gravy', price: '₹160', desc: 'Crispy chicken chunks simmered thoroughly in a rich, savory dark chili-garlic broth.', tag: '' },
            { category: 'sizzlers', name: 'White Chilli Chicken', price: '₹160', desc: 'Flagship chicken starter cooked in a rich white pepper glaze with sharp green chiles.', tag: 'Signature' },
            { category: 'sizzlers', name: 'Dragon Chicken (5 Pcs)', price: '₹180', desc: 'Five wok-fried chicken strips tossed with cashew nuts and sweet fiery red paste.', tag: '🔥 Hot Pick' },
            { category: 'sizzlers', name: 'Drums of Heaven (5 Pcs)', price: '₹180', desc: 'Five premium chicken lollipops tossed in a sweet, spicy, and sticky wok-glazed sauce.', tag: '👑 Top Seller' },
...
function renderActiveDashboard(data) {
    ...
    if (bmVals && bmVals.length >= 2) {
        bmVals.innerHTML = `₹249 <span style="font-size:0.7rem; color:var(--warm-grey);">/ Month</span>`;
        bmVals.innerHTML = `₹62.50 <span style="font-size:0.7rem; color:var(--accent-green); font-weight:800;">(RKM Sevashrama Log)</span>`;
    }
    ...
    if (modLogsNode) {
        modLogsNode.innerHTML = `
            ...
            &gt; core_engine: "RikInfinity_Engine_v4.0.0"<br>
...
const RIKINFINITY_MASTER_INTELLIGENCE = {
    ...
    rikinfinityMoat: {
        ...
        strategicLeverage: [
            "100% Direct Customer Connection (Zero lead-selling or competitor routing algorithms) [INDEX]",
            "0% Commission Cuts on food menu items (vs delivery giants 25% drops) [INDEX]",
            "97% Cost Deflation vs Overpriced Foreign Template Brokers (₹249 vs ₹8,000) [INDEX]",
            "Purulia Orphanage Transparency Trust Log (25% revenue routed to RKM Sevashrama) [INDEX]",
